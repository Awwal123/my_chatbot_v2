<template>
  <!-- Fixed input to bottom with proper styling and layout -->
  <div class="border-t  border-gray-200 bg-white px-4 py-4 md:px-8 flex-shrink-0">
    <div class="flex gap-3">
      <input
        ...
        class="flex-1 px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
      />
      <button
        @click="handleSend"
